...
> **Note on the interpreter version.** The canonical runtime is **CPython 3.13.7**. Per the governing
> "report exactly what you observe" rule, every value in this document was produced by executing the
> code under **Python 3.13.7** (reported verbatim as `PYTHON: 3.13.7` above). The DNS name codec is
