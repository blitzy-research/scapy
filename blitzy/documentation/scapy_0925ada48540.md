...
**Observed interactive banner.** Command (ANSI color codes stripped for readability; the
`conf.version` line was typed at the `>>>` prompt):
...
```
.../scapy/layers/ipsec.py:573: CryptographyDeprecationWarning: TripleDES ...
  cipher=algorithms.TripleDES,
.../scapy/layers/ipsec.py:577: CryptographyDeprecationWarning: TripleDES ...
  cipher=algorithms.TripleDES,
WARNING: No route found (no default route?)
WARNING: No route found (no default route?)
...
Script `/tmp/q4_edgeset.py` — complete stdout:
