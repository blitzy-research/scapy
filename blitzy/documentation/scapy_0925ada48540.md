...
The `except socket.error:` block at line 808 catches this `OSError` (since `OSError` is a parent of `socket.error`) and falls back to `return Net('999.999.999.999')` at line 809.
